        ...
        return Scaffold(
          ...
          body:SingleChildScrollView(
              ...
              children:<Widget>[
                ...
                Text("Brain changes that occur in Alzheimer's disease can affect moods and behaviors. Problems may include the following:"),
                Text("*  Depression"),
                Text("*  Apathy"),
                ...
                Text("*  Delusions, such as believing something has been stolen"),
                SizedBox(height:20.0),
                Text("STAGES OF ALZEIMERS ",style:TextStyle(color:Colors.blue[900])),
                SizedBox(height:10.0),
                Text("-->Stage 1: No Impairment",style: TextStyle(fontWeight:FontWeight.bold)),
                Text("During this stage, Alzheimer’s is not detectable and no memory problems or other symptoms of dementia are evident."),
                SizedBox(height:10.0),
                Text("-->Stage 2: Very Mild Decline",style: TextStyle(fontWeight:FontWeight.bold)),
                Text("The senior may notice minor memory problems or lose things around the house, although not to the point where the memory loss can easily be distinguished from normal age-related memory loss. The person will still do well on memory tests and the disease is unlikely to be detected by loved ones or physicians."),
                SizedBox(height:10.0),
                Text("-->Stage 3: Mild Decline",style: TextStyle(fontWeight:FontWeight.bold)),
                Text("At this stage, the family members and friends of the senior may begin to notice cognitive problems. Performance on memory tests are affected and physicians will be able to detect impaired cognitive function."),
                Text("People in stage 3 will have difficulty in many areas including:"),
                SizedBox(height:5.0),
                Text("Finding the right word during conversations"),
                Text("Organizing and planning"),
                Text("Remembering names of new acquaintances"),
                Text("People with stage three Alzheimer’s may also frequently lose personal possessions, including valuables."),
                SizedBox(height:10.0),
                Text("-->Stage 4: Moderate Decline",style: TextStyle(fontWeight:FontWeight.bold)),
                Text("In stage four of Alzheimer’s, clear-cut symptoms of the disease are apparent. People with stage four of Alzheimer’s:"),
                SizedBox(height:5.0),
                Text("Have difficulty with simple arithmetic"),
                Text("Have poor short-term memory (may not recall what they ate for breakfast, for example)"),
                Text("Inability to manage finance and pay bills"),
                Text("May forget details about their life histories"),
                SizedBox(height:10.0),
                Text("-->Stage 5: Moderately Severe Decline",style: TextStyle(fontWeight:FontWeight.bold)),
                Text("During the fifth stage of Alzheimer’s, people begin to need help with many day-to-day activities. People in stage five of the disease may experience:"),
                SizedBox(height:5.0),
                Text("Difficulty dressing appropriately"),
                Text("Inability to recall simple details about themselves such as their own phone number"),
                Text("Significant confusion"),        
                Text("On the other hand, people in stage five maintain functionality. They typically can still bathe and toilet independently. They also usually still know their family members and some detail about their personal histories, especially their childhood and youth."),
                SizedBox(height:10.0),
                Text("-->Stage 6: Severe Decline",style: TextStyle(fontWeight:FontWeight.bold)),
                Text("People with the sixth stage of Alzheimer’s need constant supervision and frequently require professional care. Symptoms include:"),
                SizedBox(height:5.0),
                Text("Confusion or unawareness of environment and surroundings"),
                Text("Inability to recognize faces except for the closest friends and relatives"),
                Text("Inability to remember most details of personal history"),
                Text("Loss of bladder and bowel control"),
                Text("Major personality changes and potential behavior problems"),
                Text("The need for assistance with activities of daily living such as toileting and bathing "),
                SizedBox(height:10.0),
                Text("-->Stages 7: Very Severe Decline",style: TextStyle(fontWeight:FontWeight.bold)),
                Text("Stage seven is the final stage of Alzheimer’s. Because the disease is a terminal illness, people in stage seven are nearing death. In stage seven of the disease, people lose the ability to communicate or respond to their environment. While they may still be able to utter words and phrases, they have no insight into their condition and need assistance with all activities of daily living. In the final stages of Alzheimer’s, people may lose their ability to swallow."),
                SizedBox(height:20.0),
                Text("CAUSES ",style:TextStyle(color:Colors.blue[900])),
                ...
                SizedBox(height:5.0),
                Text("Researchers are focused on the role of two proteins:"),
                SizedBox(height:5.0),
                Text("Plaques:",style: TextStyle(fontWeight:FontWeight.bold)),
                SizedBox(height:5.0),
                Text("Beta-amyloid is a leftover fragment of a larger protein. When these fragments cluster together, they appear to have a toxic effect on neurons and to disrupt cell-to-cell communication. These clusters form larger deposits called amyloid plaques, which also include other cellular debris."),
                SizedBox(height:5.0),
                Text("Tangles: ",style: TextStyle(fontWeight:FontWeight.bold)),
                SizedBox(height:5.0),
                Text("Tau proteins play a part in a neuron's internal support and transport system to carry nutrients and other essential materials. In Alzheimer's disease, tau proteins change shape and organize themselves into structures called neurofibrillary tangles. The tangles disrupt the transport system and are toxic to cells."),
                SizedBox(height:20.0),
                Text("PREVENTIONS ",style:TextStyle(color:Colors.blue[900])),
                SizedBox(height:10.0),
                Text("Alzheimer's disease is not a preventable condition. However, a number of lifestyle risk factors for Alzheimer's can be modified. Evidence suggests that changes in diet, exercise and habits — steps to reduce the risk of cardiovascular disease — may also lower your risk of developing Alzheimer's disease and other disorders that cause dementia. Heart-healthy lifestyle choices that may reduce the risk of Alzheimer's include the following:"),
                SizedBox(height:5.0),
                Text("*  Exercise regularly"),
                Text("*  Eat a diet of fresh produce, healthy oils and foods low in saturated fat"),
                Text("*  Follow treatment guidelines to manage high blood pressure, diabetes and high cholesterol"),
                Text("*  If you smoke, ask your doctor for help to quit smoking"),
                Text("*  Studies have shown that preserved thinking skills later in life and a reduced risk of Alzheimer's disease are associated with participating in social events, reading, dancing, playing board games, creating art, playing an instrument, and other activities that require mental and social engagement."),
                SizedBox(height:20.0),
              ],
            ),
          ),
